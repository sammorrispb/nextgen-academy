...
export function whatsappInviteHtml(): string {
  return `<div style="${s.card}">
    ...
    <p style="margin:0;color:${c.text};font-size:14px;line-height:1.55;">
      Quickest way to reach the other Next Gen parents &mdash; carpool plans, who&rsquo;s coming this week, what&rsquo;s working for your kid. Coach Sam&rsquo;s in there too. <a href="${WHATSAPP_PARENT_GROUP_URL}" style="${s.link}font-weight:700;">Open the WhatsApp group.</a> Better, together.
    </p>
  </div>`;
}
...
export function whatsappInviteText(): string {
  return [
    `You're invited — Next Gen parent WhatsApp. Quickest way to reach the other parents (carpool plans, who's coming this week, what's working for your kid). Coach Sam's in there too. Better, together.`,

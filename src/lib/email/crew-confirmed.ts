  ...
  <div style="${s.wrapper}">
    ...
    <div style="${s.cardAccent}">
      ...
      <p style="margin:0;color:${c.text};font-size:14px;line-height:1.55;">
        Book session 1 (4-player cap). After that first session you&rsquo;ll get a one-tap option to lock in the next 4 weeks &mdash; same time, same court, same crew. Skip a week any time, no questions asked.
      </p>
    </div>

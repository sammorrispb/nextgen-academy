...
export const coaches: Coach[] = [
  ...
  },
  {
    ...
    initials: "A",
    initialsBg: "#FF8C00",
    bio: "Tennis coach and lifelong racket sports enthusiast, Amine grew up playing tennis and ping pong, developing an elite foundation in hand-eye coordination and court strategy. His competitive drive led him to become a K-Swiss Ultimate Tennis Tampa Bay League Champion, reaching the elite 6.0 level in 2015. Now a passionate pickleball convert, he brings those top-tier racket sport fundamentals to every session. A 4.5+ pickleball player himself, he trains alongside his son Ryan\u2014a Next Gen athlete\u2014and channels that competitive father-son dynamic into his coaching. As a dad of three, Amine understands the family side of youth sports from the inside out, blending high-level athletic expertise with a personal, family-focused approach.",

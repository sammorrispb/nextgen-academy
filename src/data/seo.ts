export const seo = {
  ...
  schedule: {
    ...
    description:
      "Upcoming youth pickleball sessions for kids ages 6–16 in Montgomery County, MD — rotating MCPS courts across Rockville, Bethesda, Potomac, and beyond.",
  },
  freeEvaluation: {
  ...
  mvf: {
    ...
    description:
      "Youth pickleball classes in Montgomery Village, MD — an intro class Aug 27 and two six-week fall Thursday sessions for kids ages 8–16, coached by Next Gen. Register through MVF.",
  },
} as const;

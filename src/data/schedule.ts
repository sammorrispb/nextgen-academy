 ...
 * capped at 4 players — drop-ins only; the Fall 2026 season sets its own
 * per-group figure in `fall-2026.ts`. Private lessons remain available at any level as a

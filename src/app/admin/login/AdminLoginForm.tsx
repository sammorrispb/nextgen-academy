    ...
    return (
      <div className="px-5 py-6 rounded-2xl bg-ngpa-panel/80 border border-ngpa-teal/40">
        <p className="text-base text-ngpa-white leading-relaxed">
          Check your inbox. If your email is on the admin allowlist, a sign-in
  ...
  return (
    <form onSubmit={onSubmit} className="space-y-4">
      ...
      <button
        type="submit"
        disabled={submitting}
        className="w-full px-6 py-3.5 rounded-full bg-ngpa-teal text-ngpa-deep font-bold hover:brightness-110 transition-all disabled:opacity-60 min-h-[48px] shadow-xl shadow-ngpa-teal/20"
      >

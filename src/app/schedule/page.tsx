      ...
      <section className="relative isolate overflow-hidden bg-ngpa-deep">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-10 pt-16 sm:pt-24 pb-20 sm:pb-24">
          ...
          <p className="mt-5 text-lg text-ngpa-white/80 leading-relaxed max-w-2xl">
            $20 per 1-hour slot, or $35 for both slots in a session (pick the
            two-hour bundle at checkout). Sessions split into Early and Late
            slots — pick one or both. Each pickleball court is capped at 4 players.
          </p>
      ...
      <section className="bg-ngpa-navy py-20 sm:py-24 px-4 sm:px-6 lg:px-10">
        <div className="max-w-3xl mx-auto">
          <SectionHeading
            ...
            subtitle="$20 per 1-hour slot, or $35 for both (pick the two-hour bundle at checkout). Sessions split into Early and Late — pick one or both. Each pickleball court is capped at 4 players."
          />

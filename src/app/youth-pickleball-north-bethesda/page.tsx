...
export default function NorthBethesdaPage() {
  return (
    <CityLanding
      ...
      intro="For North Bethesda families, our Sunday-afternoon group sessions at Walter Johnson High School are just a few minutes away — a court for every level, Red through Yellow, for kids 6–16. Start with a free 30-minute evaluation and we'll place your child by skill, not just age, then you drop in session by session with no subscription."
      whereWePlay="Walter Johnson HS on Rock Spring Drive, off the I-270 spur, is the close option from North Bethesda. Earle B. Wood Middle School in Rockville has hosted Saturday sessions a short drive up the Pike in past seasons. Wherever we play, the format is the same — one court per level, capped at four players per court so every kid gets reps."
      cityFaq={[
        {
          question: "Which venue is closest to North Bethesda?",
          answer:
            "Walter Johnson High School (6400 Rock Spring Dr, Bethesda), home of this season’s Sunday-afternoon sessions, sits just off the I-270 spur minutes from North Bethesda. We’ve run Saturdays at Earle B. Wood Middle School in Rockville in past seasons. Check the schedule page for this week’s slots.",
        },
      ]}
    />
  );

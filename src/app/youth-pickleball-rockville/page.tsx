...
const DESCRIPTION =
  "Youth pickleball for kids ages 5–16 in Rockville, MD. Free 30-min evaluations, small-group sessions, and private lessons from Next Gen Academy.";
...
export default function RockvillePage() {
  return (
    <CityLanding
      ...
      intro="Next Gen Pickleball Academy coaches kids ages 5–16 from Rockville and the surrounding MoCo neighborhoods. Group sessions for kids 8+ who can rally, and private lessons for ages 5–7 (and any 8+ still learning the rally) — a clear pathway from first paddle touch to tournament play. Start with a free 30-minute evaluation."
